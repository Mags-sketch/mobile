    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              // Clear all necessary data from AsyncStorage
              await AsyncStorage.removeItem('availability');
...
const InstructorDashboard = () => (
    ...
    >
      <Drawer.Screen name="Instructor Dashboard" component={App} />
      <Drawer.Screen name="Profile" component={ProfileScreen} />
      <Drawer.Screen name="Consultations" component={ConsultationScreen} />
    </Drawer.Navigator>
